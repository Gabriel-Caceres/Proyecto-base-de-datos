...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('       RESUMEN DE VENTAS');
    DBMS_OUTPUT.PUT_LINE('==========================================');
    DBMS_OUTPUT.PUT_LINE('Trabajador: ' || v_nombre);
    DBMS_OUTPUT.PUT_LINE('Cantidad de ventas: ' || v_cantidad);
    DBMS_OUTPUT.PUT_LINE('Total vendido: $' || v_total);
    DBMS_OUTPUT.PUT_LINE('==========================================');

EXCEPTION
    WHEN NO_DATA_FOUND THEN
        DBMS_OUTPUT.PUT_LINE(
            'ERROR: No existe el trabajador con ID ' ||
            p_id_trabajador
        );
